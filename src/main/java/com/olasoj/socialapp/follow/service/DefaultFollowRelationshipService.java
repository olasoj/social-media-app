...
public class DefaultFollowRelationshipService implements FollowRelationshipService {
    ...
    @Override
    @Transactional
    public boolean toggleFollowStatus(Long socialAccountId) {
        ...
        Optional<FollowRelationShip> followRelationShip = followRepository.findFollowRelationShip(2L, socialAccountId);
        ...
        if (followRelationShip.isEmpty()) {
            ...
            //Create
            return followRepository.saveFollowRelation(2L, socialAccountId);
        } else {
